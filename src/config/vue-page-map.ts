...
export const VUE_PAGE_MAP: Record<string, VuePageEntry> = {
  // ── public: 登录前公共页面 ──
  '/':                { title: '平台首页',    icon: 'HomeFilled',   scope: 'public', source: 'src/views/platform/HomePage.vue',              load: () => import('../views/platform/HomePage.vue') },
  '/login':           { title: '登录',        icon: 'Key',          scope: 'public', source: 'src/views/platform/LoginView.vue',             load: () => import('../views/platform/LoginView.vue'), description: '用户登录页面', hidden: true },
  '/about':           { title: '关于',        icon: 'InfoFilled',   scope: 'public', source: 'src/views/platform/About.vue',                 load: () => import('../views/platform/About.vue') },
  '/demo/custom-r-table': { title: 'r-table Demo', icon: 'Grid', scope: 'public', source: 'src/views/app/CustomRTableDemo.vue', load: () => import('../views/app/CustomRTableDemo.vue'), description: '原始 RendererTable 与模板字段桥接演示', hidden: true },
  '/demo/r-form-compare': { title: 'r-form Demo', icon: 'Tickets', scope: 'public', source: 'src/views/app/RFormCompareDemo.vue', load: () => import('../views/app/RFormCompareDemo.vue'), description: '原始 RendererForm 配置式与模板式对照演示', hidden: true },
 ...
 * 从 VUE_PAGE_MAP 中 scope='public' 的条目自动派生，消除硬编码。
 */
