// src/views/SparkEJ2Demo.vue

<template>
  <div class="spark-ej2-demo">
    <div class="page-header">
      <h1>🚀 SPARK EJ2 组件演示</h1>
      <p>基于 SPARK 架构的 EJ2 组件，完全解耦的无限递归实现</p>
    </div>
    ...
    <div class="demo-sections">
      ...
      <div class="demo-section">
        ...
        <div class="grid-container">
          <SparkComponentRenderer :config="basicGridConfig" />
        </div>
      </div>
      ...
      <div class="demo-section">
        <h2>嵌套列演示</h2>
        <div class="grid-container">
          <SparkComponentRenderer :config="nestedGridConfig" />
        </div>
      </div>
      ...
      <div class="demo-section">
        <h2>分页网格演示</h2>
        <div class="grid-container">
          <SparkComponentRenderer :config="pagingGridConfig" />
        </div>
      </div>
...
// 基础网格配置
const basicGridConfig: SparkEJ2GridConfig = {
  type: 'spark-ej2-grid',
  dataSource: [
