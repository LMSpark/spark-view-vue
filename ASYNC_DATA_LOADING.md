...
可以在同一个 `data.json` 中混合使用静态数据和 API 配置：
...
### script.js
```javascript
import { $refreshData } from '../common.js'
...
```javascript
import { $refreshData, $route } from '../common.js'
