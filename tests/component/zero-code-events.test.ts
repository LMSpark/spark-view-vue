...
import { RendererTable } from '@spark-appworks/spark-component'
...
import type { PageDialogOptions, PageDialogResult, PageMessageType, PageServiceCapability } from '@spark-appworks/spark-component'
