...
$env:MYSQL_JDBC_URL = "jdbc:mysql://127.0.0.1:3406/spark_ai?useUnicode=true&characterEncoding=utf8&useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC"
...
Write-Host "  mysql:   127.0.0.1:3406/spark_ai"
