...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@spark-view/spark-page-config/navigation': path.resolve(root, 'packages', 'spark-page-config', 'src', 'navigation', 'index.ts'),
      '@spark-view/spark-page-config/runtime': path.resolve(root, 'packages', 'spark-page-config', 'src', 'runtime', 'index.ts'),
      '@spark-view/spark-page-config/json-document': path.resolve(root, 'packages', 'spark-page-config', 'src', 'json-document', 'index.ts'),
      '@spark-view/spark-page-config/design': path.resolve(root, 'packages', 'spark-page-config', 'src', 'design', 'index.ts'),
      '@spark-view/spark-page-config/ai/payloads/component-catalog.json': path.resolve(root, 'packages', 'spark-page-config', 'src', 'ai', 'payloads', 'component-catalog.json'),
      '@spark-view/spark-page-config/ai': path.resolve(root, 'packages', 'spark-page-config', 'src', 'ai', 'index.ts'),
