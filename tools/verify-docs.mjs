...
const legacyMarkdownAllowlist = new Set([
  ...
  'docs/ai/APPWORKS_AI_OPERATING_MODEL.md',
  'docs/ai/DATASET_PAGE_DESIGN_AI_FLOW_100_STEPS_ZH.md',
  'docs/ai/PAGE_DESIGN_AI_ENGINEERING_FLOW.md',
  'docs/ai/PAGE_DESIGN_AI_FILE_ORGANIZATION.md',
  'docs/ai/PAGE_DESIGN_AI_TRACE_FILES.md',
  'docs/ai/PAGE_DESIGN_AI_TRACE_INDEX.md',
  'docs/ai/SPARK_AI_CORE_RESPONSIBILITY_BOUNDARIES.md',
  'docs/ai/SPARK_AI_BUSINESS_CREATION_FLOW.md',
  'docs/ai/SPARK_AI_PACKAGE_USAGE_GUIDE.md',
  'docs/ai/SPARK_AI_PLATFORM_ARCHITECTURE_BOUNDARIES.md',
  ...
  'docs/architecture/DBMS_SCOPE_TENANT_NAVIGATION_2026-05-17.md',
  'docs/architecture/DISTRIBUTED_BATCH_TRANSACTION_ANALYSIS_ZH.md',
  ...
  'docs/guides/PLUGIN_CONFIGURATION.md',
