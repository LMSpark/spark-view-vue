...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@spark-view/spark-page-config/page': resolve(root, './packages/spark-page-config/src/page'),
      ...
      '@spark-view/spark-page-config/page/script-context-types': resolve(root, './packages/spark-page-config/src/page/script-context-types.ts'),
