...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@spark-view/spark-page-config/internal/compiler': resolve(root, './packages/spark-page-config/src/config/page-config-compiler.ts'),
      '@spark-view/spark-page-config/internal/page-data-canonicalize': resolve(root, './packages/spark-page-config/src/design/page-data-canonicalize.ts'),
      '@spark-view/spark-page-config/internal/payload-catalog': resolve(root, './packages/spark-page-config/src/ai/payload-catalog-tool-catalog.ts'),
