...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@spark-view/spark-page-config/project': resolve(root, './packages/spark-page-config/src/project.ts'),
      '@spark-view/spark-page-config/ai': resolve(root, './packages/spark-page-config/src/ai.ts'),
      '@spark-view/spark-page-config/leave-request': resolve(root, './packages/spark-page-config/src/leave-request/index.ts'),
