...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@spark-view/spark-component/runtime': path.resolve(root, 'packages', 'spark-component', 'src', 'runtime', 'index.ts'),
      ...
      '@spark-view/spark-ai/json': path.resolve(root, 'packages', 'spark-ai', 'src', 'schema', 'index.ts'),
      '@spark-view/spark-ai/agent': path.resolve(root, 'packages', 'spark-ai', 'src', 'host', 'index.ts'),
      '@spark-view/spark-ai/modules': path.resolve(root, 'packages', 'spark-ai', 'src', 'module-semantic', 'index.ts'),
