...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@spark-view/spark-page-config/capabilities': path.resolve(root, 'packages', 'spark-page-config', 'src', 'capabilities'),
      ...
      '@spark-view/spark-page-config/page/navigation': path.resolve(root, 'packages', 'spark-page-config', 'src', 'page', 'navigation.ts'),
      '@spark-view/spark-page-config/page/script-context-types': path.resolve(root, 'packages', 'spark-page-config', 'src', 'page', 'script-context-types.ts'),
      '@spark-view/spark-page-config/page/app-services': path.resolve(root, 'packages', 'spark-page-config', 'src', 'page', 'app-services.ts'),
      '@spark-view/spark-page-config/registrations/payloads/component-catalog.json': path.resolve(root, 'packages', 'spark-page-config', 'src', 'registrations', 'payloads', 'component-catalog.json'),
      '@spark-view/spark-page-config/registrations': path.resolve(root, 'packages', 'spark-page-config', 'src', 'registrations', 'index.ts'),
