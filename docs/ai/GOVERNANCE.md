...
2. 避免运行时规则、生产版主入口、组装模板、案例附录长期分叉。
3. 以当前运行时事实源为准，删除过时入口，不为旧链接保留第二套规则。
...
3. 组装模板
   ...
   这类文档用于二次组装或缩短上下文；规则正文统一引用生产版主入口，不再维护独立规则体系。
...
3. 再更新对应场景的生产版主入口文档。
4. 如果组装模板、案例附录、策略版会被这次规则影响，再同步回写相关文档。
