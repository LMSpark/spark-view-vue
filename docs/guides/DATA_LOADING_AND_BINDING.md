...
- 绑定 / 渲染： `packages/spark-component/src/components/SparkComponentRenderer.vue`、`packages/spark-component/src/components/containers/data-components/RendererTable/RendererTable.vue`
