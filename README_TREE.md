...
> 位置: `src/pageScripts/treeHelper.js`
...
import { 
  buildTreeFromFlat, 
  flattenTree 
} from '@/pageScripts/treeHelper.js'
...
```javascript
import { findNode, getNodePath } from '@/pageScripts/treeHelper.js'
...
```javascript
import { getMaxDepth, countNodes } from '@/pageScripts/treeHelper.js'
...
- **配置**: [src/mock/pages/tree-demo/data.json](src/mock/pages/tree-demo/data.json)
- **逻辑**: [src/pageScripts/tree-demo/script.js](src/pageScripts/tree-demo/script.js)
- **UI**: [src/mock/pages/tree-demo/rule.json](src/mock/pages/tree-demo/rule.json)
- **样式**: [src/mock/pages/tree-demo/style.css](src/mock/pages/tree-demo/style.css)
...
- [架构总览](README_ARCHITECTURE.md)
- [DataSet 主从表](README_ARCHITECTURE.md#dataset-数据集)
- [级联操作](README_ARCHITECTURE.md#级联操作)
- [SSR 配置](README_SSR.md)
