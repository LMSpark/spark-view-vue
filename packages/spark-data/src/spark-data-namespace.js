...
export const SparkData = {
     ...
     * })
     */
    createDataSet: (config, dataLoader) => {
     ...
     * })
     */
    createTreeManager: (config, initialNodes, bindingContext) => {
        return new TreeManager(config, initialNodes, bindingContext);
    },
    /**
     * 从 JSON 恢复 TreeManager
     */
    treeFromJSON: (json, bindingContext) => {
     ...
     */
    createContext: (hostTable, contextId = 'default', dataSet) => {
