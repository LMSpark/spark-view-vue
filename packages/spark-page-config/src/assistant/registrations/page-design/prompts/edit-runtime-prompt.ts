 ...
 *
 * 将 Host/module-semantic 架构边界、四文件编辑规则、函数纪律和 100 步流程片段组装为完整的系统提示词，
 * 在 LLM 会话初始化时注入，指导 AI 正确执行页面设计编辑操作。
 *
 * 组装顺序：HOST_SEMANTIC_ARCHITECTURE → 四文件直接编辑 → 函数纪律 → dataFirstPolicy → designFlow → dataFirstSequence
 */
