...
export class DynamicRouter {
    constructor(options) {
        ...
        this.pageComponent = options.pageComponent ?? (() => null);
 ...
 * 创建动态路由管理器
 */
export function createDynamicRouter(options) {
    return new DynamicRouter(options);
}
/**
 * 设置动态路由（便捷函数）
 */
export async function setupDynamicRoutes(router, configLoader, pageComponent) {
