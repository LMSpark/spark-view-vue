...
} from '../loader/page-content-types'
import { PageNodeFileApi } from '../file/page-file-api'
import { createPageContentLoader } from '../loader/page-content-loader'
import type {
  AppNavRoot,
  NavNode,
  NavNodeKind,
...
import { NavigationConfigClient } from '../navigation/client'
...
import { PageNodeFileCache } from '../file/page-file-cache'
import {
  PageNodeFileCreator,
  type PageNodeCreatePageParams,
} from '../file/page-file-creator'
import { PageNodeFileDeleter } from '../file/page-file-deleter'
import { PageNodeFileVersions } from '../file/page-file-versions'
import type { PageNodeFileVersionSummary } from '../file/page-file-api'
import {
...
} from '../file/page-file-registry'
import type { PageNodeFileStorage } from '../../entity/node/page-node-factory'
import type { PageDesignEditHost } from '../../contract/edit-host'
import { ProjectModel } from '../../entity/project'
import {
  ProjectReferenceClient,
  type ProjectPageReference,
  type ProjectSummary,
} from '../reference/project-reference-client'
...
export class ProjectEditor {
  ...
  createPageDesignEditHost(options: PageDesignEditHostOptions = {}): PageDesignEditHost {
    ...
    const requireMountedNavigation = (operation: string): ConfigPageNode => {
