...
export declare const SPARK_MANAGER_KEY: InjectionKey<ComponentManager>;
export declare const SPARK_REGISTRY_KEY: InjectionKey<ComponentRegistry>;
//# sourceMappingURL=spark-component.d.ts.map