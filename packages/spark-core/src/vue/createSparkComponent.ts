...
export type SparkComponent<TConfig = any> = ReturnType<typeof createSparkVueComponent>
 ...
 */
export function createSparkComponent<TConfig = any>(opts: { meta: SparkComponentMeta & { type: string }, setup?: (props: { config: TConfig }, ctx: any, helpers: any) => any }) {
