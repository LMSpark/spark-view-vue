...
describe('findCompatibleProviders', () => {
    it('returns types that provide capability with no minVersion', () => {
        componentRegistry.register('a', { type: 'a', name: 'a', version: '1.0.0', component: {}, providers: [{ name: 'cap', version: '1.0.0' }] });
        componentRegistry.register('b', { type: 'b', name: 'b', version: '1.0.0', component: {}, providers: [{ name: 'other', version: '1.0.0' }] });
        expect(componentRegistry.findCompatibleProviders('cap')).toContain('a');
    });
    it('filters by minVersion', () => {
        componentRegistry.register('c', { type: 'c', name: 'c', version: '1.0.0', component: {}, providers: [{ name: 'cap', version: '2.0.0' }] });
    ...
    it('supports semver ranges and prerelease', () => {
        componentRegistry.register('d', { type: 'd', name: 'd', version: '1.2.0', component: {}, providers: [{ name: 'cap', version: '1.2.0-alpha.1' }] });
        componentRegistry.register('e', { type: 'e', name: 'e', version: '1.2.3', component: {}, providers: [{ name: 'cap', version: '1.2.3' }] });
