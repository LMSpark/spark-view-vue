...
export function defineSparkComponent(definition) {
    ...
    const component = defineComponent({
        ...
        setup(props, _ctx) {
            ...
            const resolvedManager = (_a = inject(SPARK_MANAGER_KEY)) !== null && _a !== void 0 ? _a : inject('sparkManager');
            if (!resolvedManager) {
            ...
            function getComponent(type) {
                ...
                try {
                    ...
                    return def === null || def === void 0 ? void 0 : def.component;
                }
                catch (_b) {
                    const registry = inject(SPARK_REGISTRY_KEY);
                    return (_a = registry === null || registry === void 0 ? void 0 : registry.get(type)) === null || _a === void 0 ? void 0 : _a.component;
                }
            }
            ...
            if (definition.template) {
                ...
                const templateData = Object.assign(Object.assign({ config: props.config, helpers }, props.config.props), helpers // Allow access to helper functions
                );
                return () => {
            ...
            if (definition.templateLiteral) {
                ...
                return () => {
                    const templateFunc = definition.templateLiteral([], props, helpers);
