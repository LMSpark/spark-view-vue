...
export class MethodConnector {
    ...
    isConnected(_provider, consumer) {
        return Object.keys(consumer.interface || {}).some(k => { var _a; return typeof ((_a = consumer.implementation) === null || _a === void 0 ? void 0 : _a[k]) === 'function'; });
    }
}
    ...
    disconnectCapability(provider, consumer, context) {
        ...
        try {
            ...
            if (ok) {
                ...
                s === null || s === void 0 ? void 0 : s.delete(key2);
                if (s && s.size === 0)
