...
export class Sandbox {
    ...
    executeExpressionSync(expression, context) {
        this.validate(expression);
        const paramNames = Object.keys(Object.assign(Object.assign({}, this.options.globals), context));
        const paramValues = Object.values(Object.assign(Object.assign({}, this.options.globals), context));
    ...
    executeWithTimeoutSync(func, args) {
        ...
        const timeoutPromise = new Promise((_, reject) => {
            timeoutId = setTimeout(() => reject(new Error(`Execution timeout after ${this.options.timeout}ms`)), this.options.timeout);
        });
        try {
