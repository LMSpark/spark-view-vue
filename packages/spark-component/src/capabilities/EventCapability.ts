...
import type { CapabilityProvider, CapabilityConsumer } from '../types/spark-component.js'
import type { Implementation } from '../types/common.js'
import type { CapabilityConnector } from '../utils/SparkCapabilitySystem.js'

const logger = Logger('Spark:EventCapability')
...
export function createEventCapabilityProvider(name: string): {
  ...
  const provider: CapabilityProvider = {
    ...
    implementation: emitter as unknown as Implementation
  }
