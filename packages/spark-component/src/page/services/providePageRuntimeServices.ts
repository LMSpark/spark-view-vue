/**
 * @module @spark-appworks/spark-component:page/services/providePageRuntimeServices
 * 职责：提供 provide Page Runtime Services 在 spark-component 渲染体系中的辅助能力，连接配置、上下文和组件运行时。
