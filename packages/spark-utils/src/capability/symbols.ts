...
/** DataSet 能力 */
export const DATA_SET = defineCapability<DataSetCapability>('spark:capability:dataset')

/** DataTable 能力（管理列、视图、通用 CRUD API） */
export interface DataTableCapability {
  dataTable: IDataTableLike
}

/** DataTable 能力 */
export const DATA_TABLE = defineCapability<DataTableCapability>('spark:capability:datatable')
...
export interface DataViewCapability {
  dataView: IDataViewLike
}

/** DataView 能力 */
export const DATA_VIEW = defineCapability<DataViewCapability>('spark:capability:dataview')

// ==================== UI交互分区 ====================

/** 当前行能力 */
export interface CurrentRowCapability {
  getRow(): unknown | null
...
/** 当前行能力 */
export const CURRENT_ROW = defineCapability<CurrentRowCapability>('spark:capability:current-row')
