 ...
 * packages/spark-ai/src/registrations/page-design/payloads/component-catalog.json
...
async function main() {
  ...
  if (!existsSync(metadataPath)) {
    console.error('❌ 未找到 packages/spark-ai/src/registrations/page-design/payloads/component-catalog.json')
