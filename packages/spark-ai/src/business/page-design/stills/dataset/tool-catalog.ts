...
export type DatasetCrudToolStillFailureMode = StillFailureMode
export type DatasetCrudToolStillTarget =
  ...
  | 'relation'
  | 'dependency'
type DatasetCrudToolStillCoreFields = Omit<
  Required<
    Pick<
...
export type DatasetCrudToolStillParameterRow = DatasetCrudToolStillCoreFields & {
...
export type DatasetCrudToolStillCapabilityRow = Pick<
  DatasetCrudToolStillParameterRow,
  'action' | 'type' | 'target' | 'crudToolMethod' | 'description'
> & {
...
type DatasetCrudToolStillRowWithoutType = Omit<DatasetCrudToolStillParameterRow, 'type'>

const defineDescribeRow = (row: DatasetCrudToolStillRowWithoutType): DatasetCrudToolStillParameterRow => ({
  type: 'describe',
  ...row,
})

const defineRequestRow = (row: DatasetCrudToolStillRowWithoutType): DatasetCrudToolStillParameterRow => ({
  type: 'request',
  ...row,
})
