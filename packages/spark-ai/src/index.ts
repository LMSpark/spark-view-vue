...
// ── Unified Scenario Engine（统一场景协议）────────────────────────────────────
export {
  ...
  type AiScenarioScope,
  type AiConfirmPolicy,
  type AiRecoveryPolicy,
  type AiScenarioIdentity,
  type AiScenarioPromptPolicy,
  type AiScenarioContext,
  type AiScenarioCapabilityKind,
  type AiScenarioCapability,
  type AiScenarioPayloadSlotSource,
  type AiScenarioPayloadSlot,
  type AiScenarioPayloadContract,
  type AiScenarioFlowStepKind,
  type AiScenarioFlowStep,
  type AiScenarioFlowContract,
  type AiScenarioCompletionContract,
  type AiScenarioRecoveryHint,
  type AiScenarioToolCall,
  type AiScenarioToolRegistration,
  type AiScenarioTool,
  type AiScenarioStep,
  type AiScenarioIntentMatch,
  type AiScenarioDefinition,
  type AiScenarioResolution,
  type AiScenarioRunRequest,
  type AiScenarioToolExecution,
  type AiScenarioRunResult,
...
} from './business/scenario-engine'

// ── 分级查询协议与约束提示词 ────────────────────────────────────────────────
export {
  type AiIntentCatalog,
  type AiIntentCatalogEntry,
  type AiToolSummary,
  type AiScenarioInfo,
  type AiScenarioCapabilitiesQuery,
  type AiScenarioCapabilitiesPage,
  type AiScenarioPayloadInfo,
  type AiScenarioFlowInfo,
  type AiScenarioCompletionInfo,
  type AiScenarioRecoveryInfo,
  type AiToolSchemaInfo,
  type AiToolRegistrationInfo,
  type AiScenarioToolsQuery,
  type AiScenarioToolsPage,
  type AiToolSchemaNodeQuery,
  type AiToolSchemaNodeInfo,
...
} from './business/scenario-engine/prompt-constraints'
...
} from './business/scenario-engine/scenario-prompt-template-registry'
