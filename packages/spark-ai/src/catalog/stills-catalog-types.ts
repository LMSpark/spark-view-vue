...
/** 事件条目 */
export interface StillsEmitEntry {
  /** 事件名 */
  name: string
  /** 事件描述 */
  description?: string
...
/** 根级字段条目 */
export interface StillsRootFieldEntry {
  /** 字段名 */
  name: string
  /** TypeScript 类型字符串 */
  type: string
...
/** 嵌套规则 */
export interface StillsNestingRule {
  /** 允许的子组件类型（支持通配符如 `r-*`） */
