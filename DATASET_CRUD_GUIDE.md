...
```javascript
import { $data, $rebindRules, $refreshData } from '../common.js'
        ...
        tables: [
          {
            tableName: 'Users',
            columns: [
              { columnName: 'id', dataType: 'number', isPrimaryKey: true, caption: '用户ID' },
              { columnName: 'name', dataType: 'string', caption: '姓名' },
              { columnName: 'email', dataType: 'string', caption: '邮箱' },
              { columnName: 'status', dataType: 'string', caption: '状态' }
            ]
          },
          {
            tableName: 'Orders',
            columns: [
              { columnName: 'id', dataType: 'number', isPrimaryKey: true, caption: '订单ID' },
              { columnName: 'userId', dataType: 'number', caption: '用户ID' },
              { columnName: 'orderNo', dataType: 'string', caption: '订单号' },
              { columnName: 'amount', dataType: 'number', caption: '金额' },
              { columnName: 'status', dataType: 'string', caption: '状态' },
              { columnName: 'createdAt', dataType: 'string', caption: '创建时间' }
            ]
          }
        ],
        relations: [
...
```javascript
import { updateRow } from '../pageScripts/datasetHelper.js'
import { DataSetManager } from '../utils/dataSetManager'
...
```javascript
import { deleteRow } from '../pageScripts/datasetHelper.js'
import { DataSetManager } from '../utils/dataSetManager'
...
```javascript
// script.js
import { updateRow, deleteRow } from '../pageScripts/datasetHelper.js'
import { DataSetManager } from '../utils/dataSetManager'
import { ElMessage, ElMessageBox } from 'element-plus'
